...
//         <div
//             data-error={error}
//             className='group bg-grey-800 h-12 border border-grey-600 rounded-xl px-4 flex items-center gap-2 focus-within:border-grey-100 data-[error=true]:border-danger'
//             >
//             <span
...
export function InputField(props: InputFieldProps) {
  return <input className="flex-1 outline-0 placeholder-grey-400" {...props} />
}
